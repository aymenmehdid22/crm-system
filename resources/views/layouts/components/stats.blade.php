<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div class="bg-blue-500 text-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-lg font-bold">Entreprises: {{ cache()->get('countCompanies') }} ({{ cache()->get('deactivatedCompanies') }})</h2>
    ...
    <div class="bg-red-500 text-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-lg font-bold">Employés: {{ cache()->get('countFinances') }}({{ cache()->get('deactivatedEmployees') }})</h2>
    ...
    <div class="bg-orange-500 text-white p-6 rounded-lg shadow-md">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-lg font-bold">Contrats: {{ cache()->get('countDeals') }} ({{ cache()->get('deactivatedDeals') }})</h2>
