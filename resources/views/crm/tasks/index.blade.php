                ...
                <div class="p-3 flex justify-between items-center">
                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center border border-gray-300">Employé attribué</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Durée</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Terminé ?</th>
