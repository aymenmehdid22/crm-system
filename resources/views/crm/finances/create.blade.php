        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Ajouter  finance</p>
                    <a href="{{ url()->previous() }}">
                    ...
                    <form action="{{ route('finances.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mb-4">
                                    <label for="company_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Attribuer une entreprise</label>
                                    <div class="flex">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <select id="type" name="type" required
                                            ...
                                            <option value="proforma invoice">Facture pro</option>
                                            <option value="advance">Avance</option>
                                            <option value="simple transfer">Transfert simple</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Categorie</label>
                                    <div class="flex">
                                        <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-e-0 border-gray-300 border-e-0 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                            <span class="text-gray-500"><i class="fa fa-pencil"></i></span>
                                        </span>
...
<option value="steady income">Revenu régulier</option>
<option value="large order">Grand commande</option>
<option value="small order">Petite commande</option>
<option value="one-off order">Commande ponctuelle</option>
