        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Liste des finances</p>
                    <a href="{{ route('finances.create.form') }}" class="text-blue-500 hover:text-blue-700">
                        <button class="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150" type="button">
                            <i class="fas fa-plus"></i> Ajouter une nouvelle opération financière
                        </button>
                    </a>
                </div>
            </div>
                ...
                <div class="p-3 flex justify-between items-center">
                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center border border-gray-300">Nom</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Categorie</th>
                             <th class="px-4 py-2 text-center border border-gray-300">Type</th>
    <th class="px-4 py-2 text-center border border-gray-300">Montant brut</th>
    <th class="px-4 py-2 text-center border border-gray-300">Montant net</th>
    <th class="px-4 py-2 text-center border border-gray-300">TVA</th>
    <th class="px-4 py-2 text-center border border-gray-300">Entreprises attribuées</th>
    <th class="px-4 py-2 text-center border border-gray-300">Date</th>
    <th class="px-4 py-2 text-center border border-gray-300">Statut</th>
