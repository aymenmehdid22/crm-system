                ...
                <div class="p-6 flex justify-between items-center">
                    ...
                    <a href="{{ route('sales.create.form') }}" class="text-blue-500 hover:text-blue-700">
                        <button class="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
                                type="button">
                            <i class="fas fa-plus"></i> Ajoute une nouvelle vente
                        </button>
                    </a>
                </div>
            </div>
                ...
                <div class="p-3 flex justify-between items-center">
                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center border border-gray-300">Quantité</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Prix</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Produit</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Date de Paiment</th>
