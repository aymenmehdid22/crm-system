                ...
                <div class="p-6 flex justify-between items-center">
                    ...
                    <a href="{{ route('deals.create.form') }}" class="text-blue-500 hover:text-blue-700">
                        <button class="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150" type="button">
                            <i class="fas fa-plus"></i> Ajouter une nouvelle contrat
                        </button>
                    </a>
                </div>
            </div>
                ...
                <div class="p-3 flex justify-between items-center">
                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center border border-gray-300">Accord entre entreprises</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Heure de début</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Heure de fin</th>
                            <th class="px-4 py-2 text-center border border-gray-300">Entreprises assignées</th>
