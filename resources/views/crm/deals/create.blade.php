                ...
                <div class="p-6">
                    <form action="{{ route('deals.store') }}" method="POST">
                        ...
                        <div class="flex justify-end border-t border-gray-200">
                            <button type="submit" class="bg-blue-500 mt-3 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Ajouter un contrat</button>
                        </div>
                    </form>
                </div>
            </div>
