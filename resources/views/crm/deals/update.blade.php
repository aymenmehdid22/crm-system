        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Ajouter une nouvelle contrat</p>
                    <a href="{{ url()->previous() }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <select id="category" name="category" required
                                            ...
                                            <option value="steady income" @if($deal->category == 'steady income') selected @endif>Revenu stable</option>
                                            <option value="large order" @if($deal->category == 'large order') selected @endif>Grande commande</option>
                                            <option value="small order" @if($deal->category == 'small order') selected @endif>Petite commande</option>
                                            <option value="one-off order" @if($deal->category == 'one-off order') selected @endif>Commande ponctuelle</option>
                                        </select>
                                    </div>
                                </div>
