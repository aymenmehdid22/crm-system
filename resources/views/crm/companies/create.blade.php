        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Ajouter un Entrprise</p>
                    <a href="{{ url()->previous() }}">
                    ...
                    <form action="{{ route('companies.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    <label for="client_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Assigner un client</label>
                                    <div class="flex">
                        ...
                        <div class="flex justify-end border-t border-gray-200">
                            <button type="submit" class="bg-blue-500 mt-3 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Ajouter une entreprise</button>
                        </div>
                    </form>
                </div>
            </div>
