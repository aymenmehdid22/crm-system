        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Liste des entreprises</p>
                ...
                <div class="p-3 flex justify-between items-center">
                    <table class="min-w-full table-auto border-collapse border border-gray-200">
                        ...
                        <tr>
                          ...
                          <th class="px-4 py-2 text-center border border-gray-300">Ville</th>
                          <th class="px-4 py-2 text-center border border-gray-300">Pays</th>
                          <th class="px-4 py-2 text-center border border-gray-300">Taille de l’entreprise</th>
                          <th class="px-4 py-2 text-center border border-gray-300">Numéro fiscal</th>
