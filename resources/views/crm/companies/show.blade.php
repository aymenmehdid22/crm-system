                    ...
                    <div class="py-6">
                        ...
                        <div x-show="tab === 'home'">
                            <table class="w-full text-left border border-gray-300">
                                ...
                                <tr class="border-b">
                                    <th class="px-4 py-2">Numéro fiscal	</th>
                                ...
                                <tr class="border-b">
                                    <th class="px-4 py-2">Adresse de facturation</th>
                                ...
                                <tr class="border-b">
                                    <th class="px-4 py-2">Nombre d’employés</th>
                                    <td class="px-4 py-2">{{ $company->employees_size }}</td>
                                </tr>

                                <tr class="border-b">
                                    <th class="px-4 py-2">Assigner un client</th>
                                    <td class="px-4 py-2">
