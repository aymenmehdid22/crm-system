        ...
        <main class="flex-1 p-6 overflow-y-auto">
            ...
            <div class="w-full bg-white shadow-md rounded-lg mb-3">
                <div class="p-6 flex justify-between items-center">
                    <p class="text-xl">Détails de produit : {{ $product->name }}</p>
                    <a href="{{ url()->previous() }}">
...
{{ new \Cknow\Money\Money($product->price, new \Money\Currency(\App\Queries\SettingQueries::getSettingValue('currency'))) }}
